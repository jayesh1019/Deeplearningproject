...
class DataTransformation:
    ...
    def transforming_training_data(self) -> transforms.Compose:
        try:
            logging.info("Entered the transforming_training_data method of Data transform")
    ...
    def initiate_data_transformation(self) -> DataTransformationArtifact:
        try:
            ...
            train_transforms: transforms.Compose = self.transforming_training_data()

            test_transforms: transforms.Compose = self.transforming_testing_data()
