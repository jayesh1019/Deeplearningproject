...
class ModelTrainer:
    def __init__(
        ...
        moodel_trainer_config: ModelTrainerConfig,
    ):
        self.model_trainer_config: ModelTrainerConfig = moodel_trainer_config
    ...
    def train(self , optimizer: optimizer) -> None:
        ...
        try:
            ...
            for batch_idx, (data, target) in enumerate(pbar):
                ...
                # In pytorch, gradient is accumulated over backprop and even though thats used in     
                # RNN generally not used in CNN or specific requirements
                # prediction on data
    ...
    def test(self) -> None:
        try:
            ...
            logging.info("Entered the test method of Model triner class")
    ...
    def initiate_model_trainer(self) -> ModelTrainerArtifact:
        try:
            ...
            module: Module = self.model.to(self.model_trainer_config.device)
